export const OBSERVED_FEATURES = [
  {field: 'EP_CROWD', 'Estimated percent crowding'},
  {field: 'EP_LIMENG', 'Estimated percent population with limited English skills'},
  ...
  { field: 'EP_POV', name:'stimated percent population below poverty threshold'},
